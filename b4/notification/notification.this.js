...
function addReminderMessageToChat(text) {
    ...
    messageElement.innerHTML = `<strong style="color: #9333ea;">Reminder:</strong> <strong style="color: #159b75ff;">"${text}"</strong>`;
...
export default function sendReminderNotification(reminderText) {
    ...
    sendDesktopNotification('Reminder Due!', reminderText);
}
